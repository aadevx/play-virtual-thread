...
public class PlayDocumentation extends Controller {
  ...
  public static void page(String id, String module, String docLang) throws Exception {
    ...
    if (module != null) {
      page = new File(Play.modules.get(module), "documentation/manual/" + id + ".textile");
    }
    ...
    if (id.equals("home") && module == null) {
      for (String key : Play.modules.keySet()) {
        File mr = Play.modules.get(key);
        File home = new File(mr, "documentation/manual/" + "home.textile");
        if (home.exists()) {
          modules.add(key);
        }
        if (new File(mr, "documentation/api/index.html").exists()) {
          apis.add(key);
        }
      }
    }
  ...
  public static void image(String name, String module, String lang) {
    ...
    if (module != null) {
      image = new File(Play.modules.get(module), "documentation/images/" + name + ".png");
    }
    if (!image.exists()) {
      notFound();
    }
  ...
  public static void file(String name, String module, String lang) {
    ...
    if (module != null) {
      file = new File(Play.modules.get(module), "documentation/files/" + name);
    }
    if (!file.exists()) {
      notFound();
    }
