...
class PlayApplication(object):
    ...
    def java_cmd(self, java_args, cp_args=None, className='play.server.Server', args = None):
        ...
        java_args.append('--add-opens')
        java_args.append('java.base/java.lang=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/java.util=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/java.util.concurrent=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/java.net=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.desktop/sun.awt.image=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/sun.security.x509=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/sun.security.util=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/java.io=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('java.base/java.nio.charset=ALL-UNNAMED')
        java_args.append('--add-opens')
        java_args.append('jdk.unsupported/sun.reflect=ALL-UNNAMED')
        java_args.append('--add-exports')
        java_args.append('java.base/sun.security.provider=ALL-UNNAMED')
        java_args.append('--add-exports')
        java_args.append('java.base/sun.security.provider.certpath=ALL-UNNAMED')
