...
def execute(**kargs):
    ...
    vm_arguments = vm_arguments +' -Xshare:off'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/java.lang=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/java.util=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/java.util.concurrent=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/java.net=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.desktop/sun.awt.image=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/sun.security.x509=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/sun.security.util=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/java.io=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' java.base/java.nio.charset=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-opens'
    vm_arguments = vm_arguments +' jdk.unsupported/sun.reflect=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-exports'
    vm_arguments = vm_arguments +' java.base/sun.security.provider=ALL-UNNAMED'
    vm_arguments = vm_arguments +' --add-exports'
    vm_arguments = vm_arguments +' java.base/sun.security.provider.certpath=ALL-UNNAMED'
