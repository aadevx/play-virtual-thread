...
public class OAuth2 {
    ...
    public Response retrieveAccessToken(String callbackURL) {
        ...
        HttpResponse response = new HttpResponse(WS.url(accessTokenURL).params(params).get());
    ...
    public static class Response {
        ...
        private Response(String accessToken, Error error, HttpResponse response) {
        ...
        public static Response error(Error error, HttpResponse response) {
            return new Response(null, error, response);
        }

        private String getAccessToken(HttpResponse httpResponse) {
    ...
    public static class Error {
        ...
        static Error oauth2(HttpResponse response) {
