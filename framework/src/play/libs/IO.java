...
public class IO {
    ...
    public static void appendContent(CharSequence content, File file, String encoding) {
        try {
            Files.writeString(file.toPath(), content, toCharset(encoding), StandardOpenOption.APPEND);
        } catch (IOException e) {
            throw new UnexpectedException(e);
        }
    }

    public static void appendContent(CharSequence content, File file) {
        try {
            Files.writeString(file.toPath(), content, UTF_8, StandardOpenOption.APPEND);
        } catch (IOException e) {
            throw new UnexpectedException(e);
        }
    }
