...
public class JavaExtensions {
    ...
    protected static boolean eval(Object condition) {
        ...
        if (condition instanceof Collection list && list.isEmpty()) {
            return false;
        }
        return !(condition instanceof String string) || !string.isEmpty();
    }
    ...
    public static String asdate(Long timestamp, String pattern, String lang) {
        return DateTimeFormatter.ofPattern(pattern, Lang.getLocaleOrDefault(lang)).format(Time.toLocalDateTime(timestamp));
    }
    ...
    public static Object last(List<?> items) {
        return (items == null) ? null : items.getLast();
    }
