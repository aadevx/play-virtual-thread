...
public class Java {
    ...
    private static JavaWithCaching _javaWithCaching = new JavaWithCaching();

    private static JavaWithCaching getJavaWithCaching() {
    ...
    public static Object invokeStatic(String clazz, String method) throws Exception {
        return invokeStatic(Play.classes.loadClass(clazz), method, new Object[0]);
    }
    ...
    public static Object invokeChildOrStatic(Class<?> clazz, String method, Object... args) throws Exception {
        ...
        List<Class> assignableClasses = Play.classes.getAssignableClasses(clazz);
