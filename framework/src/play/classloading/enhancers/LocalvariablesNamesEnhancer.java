...
public class LocalvariablesNamesEnhancer extends Enhancer {
    ...
    static final Pattern pattern = Pattern.compile("^controllers\\..*\\$class$");
    @Override
    public void enhanceThisClass(ApplicationClass applicationClass) throws Exception {
        ...
        if (!ctClass.subtypeOf(classPool.get(LocalVariablesSupport.class.getName())) && !pattern.matcher(ctClass.getName()).matches()) {
            return;
        }
