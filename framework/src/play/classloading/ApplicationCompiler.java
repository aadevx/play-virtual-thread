...
public class ApplicationCompiler {
    ...
    public ApplicationCompiler(ApplicationClasses applicationClasses) {
        ...
        if (Stream.of("17", "18", "19", "20").anyMatch(runningJavaVersion::startsWith)) {
            throw new CompilationException("JDK version prior to 21  are not supported to run the application");
        }
    ...
    final class CompilationUnit implements ICompilationUnit {
        ...
        public char[] getContents() {
            return applicationClasses.getApplicationClass(clazzName).source().toCharArray();
        }
