...
public abstract class PlayExceptionWithJavaSource extends PlayException implements SourceAttachment {
    ...
    public String getSourceFile() {
        return isSourceAvailable() && applicationClass.javaFile != null ? FileUtils.relativePath(applicationClass.javaFile) : null;
    }

    @Override
    public List<String> getSource() {
        return isSourceAvailable() ? asList(applicationClass.source().split("\n")) : Collections.<String>emptyList();
    }
    ...
    public boolean isSourceAvailable() {
        return applicationClass != null && applicationClass.source() != null;
    }
}
