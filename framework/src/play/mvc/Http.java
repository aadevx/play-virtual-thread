...
public class Http {
    ...
    public static class Cookie implements Serializable {
         ...
         * Cookie path
         */
        //Edited by @ilyas. Minta tolong di review bareng
//        public String path = Play.ctxPath + "/";
    ...
    public static class Request implements Serializable {
        ...
        public static Request createRequest(String _remoteAddress, String _method, String _path, String _querystring, String _contentType,
            ...
            // must try to esaxtract encoding-info from contentType
        ...
        protected void parseXForwarded() {
            ...
            if (Play.configuration.containsKey("XForwardedSupport") && headers.get("x-forwarded-for") != null) {
                if (!"ALL".equalsIgnoreCase(Play.configuration.getProperty("XForwardedSupport"))
                        && !Arrays.asList(pattern.split(Play.configuration.getProperty("XForwardedSupport", "127.0.0.1")))
    ...
    public static class Response {
        ...
        public void setCookie(String name, String value, String domain, String path, Integer maxAge, boolean secure, boolean httpOnly) {
            setCookie(name, value, domain, path, maxAge, secure, false, "Lax");
        }
...
//            path = Play.ctxPath + path;
        ...
        public void cacheFor(String etag, String duration, long lastModified) {
            int maxAge = Time.parseDuration(duration);
            setHeader("Cache-Control", "max-age=" + maxAge);
            setHeader("Last-Modified", Utils.httpFormatter.format(Time.toLocalDateTime(lastModified)));
            setHeader("Etag", etag);
        }
    ...
    public abstract static class Inbound {
        ...
        public Inbound() {
            stream = new BlockingEventStream<>();
        }
    ...
    public static class WebSocketEvent {
        ...
        public static F.Matcher<WebSocketEvent, WebSocketClose> SocketClosed = new F.Matcher<WebSocketEvent, WebSocketClose>() {
            ...
            public F.Option<WebSocketClose> match(WebSocketEvent o) {
                if (o instanceof WebSocketClose webSocketClose) {
                    return F.Option.Some(webSocketClose);
                }
        ...
        public static F.Matcher<WebSocketEvent, String> TextFrame = new F.Matcher<WebSocketEvent, String>() {
            ...
            @Override
            public F.Option<String> match(WebSocketEvent o) {
        ...
        public static F.Matcher<WebSocketEvent, byte[]> BinaryFrame = new F.Matcher<WebSocketEvent, byte[]>() {
            ...
            @Override
            public F.Option<byte[]> match(WebSocketEvent o) {
                if (o instanceof WebSocketFrame frame) {
                    if (frame.isBinary) {
