...
public class ActionInvoker {
    ...
    public static void resolve(Request request) {
        ...
        initActionContext(request, Http.Response.current());
    ...
    private static void initActionContext(Request request, Http.Response response) {
    ...
    public static void invoke(Request request, Http.Response response) {
        ...
        try {
            ...
            if(request.routeArgs != null && !request.routeArgs.isEmpty())
            ...
            if(request.querystring != null && !request.querystring.isEmpty()) {
                ...
                String encoding = Request.current().encoding;
    ...
    private static void handleBefores(Request request) throws Exception {
    ...
    private static void handleAfters(Request request) throws Exception {
     ...
     */
    static void handleFinallies(Request request, Throwable caughtException) throws PlayException {
    ...
    public static void inferResult(Object o) {
        ...
        if (o != null && !(o instanceof NoResult)) {
            switch (o) {
                case Result result ->  throw result;
                case InputStream is -> Controller.renderBinary(is);
                case File file -> Controller.renderBinary(file);
                case Map map -> Controller.renderTemplate(map);
                case Object[] objs -> Controller.render(objs);
    ...
    private static Class<? extends PlayController> getControllerClass() {
        return Request.current().controllerClass;
    }
}
