...
public class Scope {
    ...
    public static final boolean COOKIE_SECURE = Play.configuration.getProperty("application.session.secure", "false").equalsIgnoreCase("true");
    public static final String COOKIE_EXPIRE = Play.configuration.getProperty("application.session.maxAge");
    public static final boolean SESSION_HTTPONLY = Play.configuration.getProperty("application.session.httpOnly", "false").equalsIgnoreCase("true");
    public static final String SESSION_SAMESITE = Play.configuration.getProperty("application.session.samesite", "Lax");
    public static final boolean SESSION_SEND_ONLY_IF_CHANGED = Play.configuration.getProperty("application.session.sendOnlyIfChanged", "false").equalsIgnoreCase("true");
    public static final String HEADER_FLASH_ERROR="FLASH_ERROR";
    ...
    public static class Flash implements Serializable {
        ...
        public void error(String value, Object... args) {
            ...
            Http.Response.current().setHeader(HEADER_FLASH_ERROR, "true");
        }
    ...
    public static class Params implements Serializable {
            ...
            if (!requestIsParsed) {
                ...
                if (request == null) {
                    ...
                    if (contentType != null) {
                        ...
                        if (dataParser != null && request.body != null) {
        ...
        public Map<String, String[]> sub(String prefix) {
            ...
            data.forEach((k, v) -> {
                if (k.startsWith(prefix + ".")) {
                    result.put(k.substring(prefix.length() + 1), v);
                }
            });
            return result;
        }
        ...
        public Map<String, String> allSimple() {
            ...
            data.forEach((k, v) -> result.put(k, v[0]));
            return result;
        }
        ...
        void __mergeWith(Map<String, String> map) {
            map.forEach((k, v) -> Utils.Maps.mergeValueInMap(data, k, v));
        }
