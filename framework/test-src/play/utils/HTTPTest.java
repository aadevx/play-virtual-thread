...
public class HTTPTest {
    ...
    public void testIsModifiedMethod() throws ParseException {
        ...
        LocalDateTime date = LocalDateTime.from(Utils.httpFormatter.parse("Thu, 16 Jan 2018 12:13:14 GMT"));
        String unknown = "unknown";
        long lastModified = date.toEpochSecond(ZoneOffset.UTC);
        String ifModifiedSince = Utils.httpFormatter.format(date);
        String ifModifiedSinceOld = Utils.httpFormatter.format(date.minusDays(1));
