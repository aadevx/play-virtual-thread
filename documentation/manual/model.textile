...
bc. @Table
public class Data extends BaseTable {
...
h2. <a name="hibernate">Persist your object model</a>

When you define entities by adding <code>@Table</code> annotations to any Java object, Play will automatically start a domain object model.
