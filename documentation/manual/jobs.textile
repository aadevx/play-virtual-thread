...
Jobs are fully managed by the framework. That means that Play will manage all the database connection stuff, transactions management for you. To create a job you just need to extend the @play.jobs.Job@ super class.
